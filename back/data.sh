...
# creating bounty
http --ignore-stdin PUT localhost:8080/api/bounty title='Make Tushonka' issuer=0x465DCa9995D6c2a81A9Be80fBCeD5a770dEE3daE price=1000 expiry=1593425683 type='contest' desc='' short_desc='Please find modern European cuisine recipes' complexity='advanced'
http --ignore-stdin PUT localhost:8080/api/bounty title='Solve the Black and Scholes Equation' issuer=0xe49b55119D6a74783CA23482e8dc5a3DE21085f5 price=100000 expiry=1693455693 type='traditional' desc='I love BSE, solve it for me, please.' short_desc='do you know about PDEs?' complexity='advanced'
http --ignore-stdin PUT localhost:8080/api/bounty title='Data Bounty Platform For Ocean Protocol' issuer=0xe49b55119D6a74783CA23482e8dc5a3DE21085f5 price=14000 expiry=1693455693 type='cooperative' desc='In this task we ask you to provide with an implementation of the data bounty platform for Ocean Protocol' short_desc='Create a data bounty platform for Ocean' complexity='intermediate'
http --ignore-stdin PUT localhost:8080/api/bounty title='Homomorphic Encryption of Hedge Fund Data' issuer=0xe49b55119D6a74783CA23482e8dc5a3DE21085f5 price=21500 expiry=1693455693 type='contest' desc='If you implement this, it will enable dozens of data scientists around the world to run the algorithms on our data' short_desc='We need you to implement homomorphic encryption of time-series data' complexity='beginner'
...
http --ignore-stdin PUT localhost:8080/api/bounty title='Thermodynamic Fluid Simulation' issuer=0xe49b55119D6a74783CA23482e8dc5a3DE21085f5 price=40000 expiry=1693455693 type='cooperative' desc='Our numerical computation skills arent top notch, please help us to numerically simulate thermodynamic fluids' short_desc='Do you know numerical methods? Then this task is for you' complexity='beginner'
http --ignore-stdin PUT localhost:8080/api/bounty \
title='Do greatest at in learning steepest' issuer=0x00C37502Be36F1f2E8a87f3024B71D7388f0B0E1 price=1000 \
...
issuer=0x00C37502Be36F1f2E8a87f3024B71D7388f0B0E1 price=100000 expiry=1693455693 type='traditional'
http --ignore-stdin PUT localhost:8080/api/bounty title='He do subjects prepared bachelor juvenile' \
issuer=0x00C37502Be36F1f2E8a87f3024B71D7388f0B0E1 price=14000 expiry=1693455693 type='cooperative' complexity='intermediate'
http --ignore-stdin PUT localhost:8080/api/bounty title='Domestic confined any but son bachelor' \
issuer=0x00C37502Be36F1f2E8a87f3024B71D7388f0B0E1 price=21500 expiry=1693455693 type='contest' complexity='beginner'
http --ignore-stdin PUT localhost:8080/api/bounty title='Extended kindness trifling remember he' \
issuer=0xe49b55119D6a74783CA23482e8dc5a3DE21085f5 price=33000 expiry=1693455693 type='traditional' complexity='beginner'
...
issuer=0xe49b55119D6a74783CA23482e8dc5a3DE21085f5 price=1000 expiry=1593425683 type='contest' complexity='advanced'
http --ignore-stdin PUT localhost:8080/api/bounty title='Open they an busy they my such high' \
issuer=0xe49b55119D6a74783CA23482e8dc5a3DE21085f5 price=100000 expiry=1693455693 type='traditional' complexity='advanced'
http --ignore-stdin PUT localhost:8080/api/bounty title='Men received far his dashwood subjects' \
issuer=0xe49b55119D6a74783CA23482e8dc5a3DE21085f5 price=14000 expiry=1693455693 type='cooperative' complexity='intermediate'
http --ignore-stdin PUT localhost:8080/api/bounty title='An active dinner wishes at unable' \
issuer=0x465DCa9995D6c2a81A9Be80fBCeD5a770dEE3daE price=21500 expiry=1693455693 type='contest' complexity='beginner'
http --ignore-stdin PUT localhost:8080/api/bounty title='Wholly uneasy at missed be of pretty whence' \
issuer=0x465DCa9995D6c2a81A9Be80fBCeD5a770dEE3daE price=33000 expiry=1693455693 type='traditional' complexity='beginner'
